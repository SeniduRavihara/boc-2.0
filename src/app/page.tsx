...
export default function Home() {
  ...
  return (
    <main className="flex flex-col relative bg-[#050812]">
      ...
      {/* ════════════════════════════════════════════════
          PHASE 1 / 2  ─  Hero + Linux environment rise
          GSAP ScrollTrigger pinned zone (unchanged).
      ════════════════════════════════════════════════ */}
      <div
        ref={pinnedRef}
      ...
      >
        ...
        {/* OS window — rises and expands via GSAP */}
        <div
          ref={windowRef}
        ...
        >
          {/*
            LinuxEnvironment shows during the rise + expansion.
            Once the user scrolls into the SectionScrollZone,
            LinuxShell (below) takes over visually — same wallpaper
            + topbar style makes the cut invisible.
          */}
          <LinuxEnvironment />
        </div>
      </div>
      ...
      {/* ════════════════════════════════════════════════
          PHASE 3+  ─  Section dock navigation
          ─────────────────────────────────────────────
          Each section gets SECTION_BAND_VH of scroll space.
          LinuxShell is sticky so it stays visible the whole time.
          Scroll position → activeSection → magic lamp open/close.
          Clicking a dock icon scrolls to that section's band.
      ════════════════════════════════════════════════ */}
      <div
        ref={sectionZoneRef}
        className="relative"
      ...
      {/* ════════════════════════════════════════════════
          Footer — normal document flow after all sections
      ════════════════════════════════════════════════ */}
      <Footer />
    </main>
  );
